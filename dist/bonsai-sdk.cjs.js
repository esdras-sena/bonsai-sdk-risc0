...
class ProofData {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(ProofData.prototype);
        obj.__wbg_ptr = ptr;
        ProofDataFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    get seal() {
        try {
            ...
            wasm.proofdata_seal(retptr, this.__wbg_ptr);
    ...
    get journal() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.proofdata_journal(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var v1 = getArrayU8FromWasm0(r0, r1).slice();
            wasm.__wbindgen_free(r0, r1 * 1, 1);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('bincode2proof_bg.wasm', (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('bonsai-sdk.cjs.js', document.baseURI).href)));
    }
...
const VERSION_HEADER = "x-risc0-version";
/// Environment variable name for the API url
const API_URL_ENVVAR = "BONSAI_API_URL";
/// Environment variable name for the API key
const API_KEY_ENVVAR = "BONSAI_API_KEY";
/// Environment variable name for the timeout, either a number in ms or "none" for no timeout
const TIMEOUT_ENVVAR = "BONSAI_TIMEOUT_MS";
...
class SessionId {
    ...
    status(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield client.client.get(url);
            if (!(res.status === 200)) {
    ...
    execOnlyJournal(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const buffer = yield res.data.arrayBuffer();
...
class Client {
    constructor(_url, _client) {
        this.url = _url;
        this.client = _client;
    }
    static fromParts(url, key, risc0Version) {
        let client;
        try {
    ...
    getImageUploadUrl(imageId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield this.client.get(requestUrl);
            if (res.status === 204) {
                return { kind: "Exists" };
            }
            if (!(res.status === 200)) {
            ...
            const data = yield res.data.json();
    ...
    putData(url, body) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            try {
                const response = yield this.client.put(url, body);
    ...
    uploadImg(imageId, buf) {
        return __awaiter(this, void 0, void 0, function* () {
            const resOrExists = yield this.getImageUploadUrl(imageId);
            if (resOrExists.kind === "Exists") {
                return true;
            }
            else if (resOrExists.kind === "New") {
                yield this.putData(resOrExists.data.url, buf);
                return false;
            }
            else {
    ...
    uploadInput(encoded) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let uploadData = yield this.getUploadUrl("inputs");
            yield this.putData(uploadData.url, buf);
            return uploadData.uuid;
        });
    }
    uploadReceipt(buf) {
        return __awaiter(this, void 0, void 0, function* () {
            let uploadData = yield this.getUploadUrl("receipts");
            yield this.putData(uploadData.url, buf);
            return uploadData.uuid;
        });
    }
    receiptDownload(sessionId) {
        return __awaiter(this, void 0, void 0, function* () {
            const requestUrl = `${this.url}/receipts/${sessionId.uuid}`;
            const res = yield this.client.get(requestUrl, { validateStatus: () => true });
            ...
            return yield this.download(receipt.url);
        });
    }
    download(url) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const res = yield this.client.get(url, { responseType: 'arraybuffer' });
                return new Uint8Array(res.data);
            }
            catch (error) {
                throw new SdkErr(`Download failed: ${error.message}`);
            }
        });
    }
    imageDelete(imageId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield this.client.delete(requestUrl, { validateStatus: () => true });
            if (res.status < 200 || res.status >= 300) {
                const body = typeof res.data === "string" ? res.data : JSON.stringify(res.data);
                throw new InternalServerError(`Internal server error: ${body}`);
            }
    ...
    createSessionWithLimit(imgId, inputId, assumptions, executeOnly, execCycleLimit) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let res = yield this.client.post(requestUrl, req);
            if (res.status < 200 || res.status >= 300) {
                const body = typeof res.data === "string" ? res.data : JSON.stringify(res.data);
                throw new InternalServerError(`Internal server error: ${body}`);
            }
    ...
    createSession(imgId, inputId, assumptions, executeOnly) {
        return __awaiter(this, void 0, void 0, function* () {
            let sessionId = yield this.createSessionWithLimit(imgId, inputId, assumptions, executeOnly, undefined);
            return sessionId;
        });
    }
    createSnark(sessionId) {
        return __awaiter(this, void 0, void 0, function* () {
...
function constructReqClient(apiKey, version) {
    const headers = {};
...
exports.getSealAndJournal = getSealAndJournal;
//# sourceMappingURL=bonsai-sdk.cjs.js.map
